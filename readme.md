...
| /telegram start      | SocialBridge.telegram.startBot   | Just start bot if bot are disabled                           |
| /telegram stop       | SocialBridge.telegram.stopBot    | Just stop bot and disconnect from telegram                   |
