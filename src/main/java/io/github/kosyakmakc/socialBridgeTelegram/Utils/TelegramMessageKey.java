...
public class TelegramMessageKey {
    public static final MessageKey SET_TOKEN_DESCRIPTION = new MessageKey("set_token_description");
    ...
    public static final MessageKey BOT_STATUS_DESCRIPTION = new MessageKey("bot_status_description");
